...
1. On the Web Scheduler page, locate the agent you want to interact with.
2. Click on "Chat" option from the three-dot menu.
3. This will open the chat interface for the selected Web Scheduler.

### Using the Chat Interface

1. Type in your event details as prompted by the agent.
2. Press Enter or click the Send button to submit your details.
3. The Web Scheduler will process your information and suggest available time slots based on your calendar.
4. Confirm the booking when you're satisfied with the proposed time.
